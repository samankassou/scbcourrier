        ...
        <table class="w-full whitespace-no-wrap">
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-sm">
                        <button title="@lang("Edit")" class="text-yellow-600 hover:text-yellow-900"
                        ...
                        <button title="@lang("Delete")" class="text-yellow-600 hover:text-yellow-900" wire:click="$emit('openModal', 'admin.users.delete', {{ json_encode(["user" => $user->id]) }})">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
